...
/* 乘积除以2必须是DCMI双缓存区单个缓存大小的整数倍 */
#define IMAGE_WIN_WIDTH         320       //定义摄像头显示窗口大小
#define IMAGE_WIN_HEIGHT        256       //定义摄像头显示窗口大小
#define GUI_RESET_WIN           LCD_Set_Window(0,0,lcd_dev.width,lcd_dev.height);

// 底部状态栏位置
#define GUI_STAUS_BAR_FONT      24        //状态栏中文本的字体大小
#define GUI_STAUS_BAR_X         (lcd_dev.width-(lcd_dev.width-IMAGE_WIN_WIDTH-(lcd_dev.height-IMAGE_WIN_HEIGHT)))  //offset 30 使得帧率文本贴近右下角
