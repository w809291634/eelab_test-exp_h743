...
* 名称：OV2640_Init
* 功能：初始化OV2640 
* 参数：参数 MID 保存读取出来的 Manufacturer ID 
...
/*********************************************************************************************
* 名称：OV2640_Resolution_1600_1200
* 功能：采用SXGA分辨率(1600*1200)  
* 参数：无
* 返回：无
* 修改：无
* 注释：无
...
/*********************************************************************************************
* 名称：OV2640_Resolution_800_600
* 功能：采用SVGA分辨率(SVGA 800*600)
* 参数：无
* 返回：无
* 修改：无
* 注释：无
...
/*********************************************************************************************
* 名称：OV2640_RGB565_Mode
* 功能：OV2640切换为RGB565模式
* 参数：无
* 返回：无
* 修改：无
* 注释：无
...
/*********************************************************************************************
* 名称：OV2640_ImageSize_Set
* 功能：该函数设置图像尺寸大小,也就是所选格式的输出分辨率
* 参数：UXGA:1600*1200,SVGA:800*600,CIF:352*288
...
/*********************************************************************************************
* 名称：OV2640_ImageWin_Set
* 功能：设置图像开窗大小
* 参数：width,height:宽度(对应:horizontal)和高度(对应:vertical),width和height必须是4的倍数
* 返回：返回值:0,设置成功
*                     其他,设置失败
* 修改：无
* 注释：由:OV2640_ImageSize_Set确定传感器输出分辨率从大小.
...
/*********************************************************************************************
* 名称：OV2640_OutSize_Se
* 功能：设置图像输出大小
* 参数：width,height:宽度(对应:horizontal)和高度(对应:vertical),width和height必须是4的倍数
* 返回：返回值:0,设置成功
*                     其他,设置失败
* 修改：无
* 注释：OV2640输出图像的大小(分辨率),完全由改函数确定
*******************************************************************************************/
...
/*********************************************************************************************
* 名称：ov2640_speed_ctrl
* 功能：OV2640速度控制
* 参数：无
* 返回：无
* 修改：无
* 注释：根据LCD分辨率的不同，设置不同的参数
*******************************************************************************************/
